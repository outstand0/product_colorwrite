...
namespace USBInterface
{
    internal class HidApi
    {
        ...
        [DllImport(DLL_FILE_NAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr hid_enumerate2(ushort vendor_id, ushort product_id);
        ...
        [DllImport(DLL_FILE_NAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr hid_open2(ushort vendor_id, ushort product_id, ushort usage, ushort usage_page);
